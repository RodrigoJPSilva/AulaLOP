...
public class situacaoDesafioTeste {
	...
	public static void main(String[] args) {
		...
		/* Vetor [0] Salário bruto, vetor [1] INSS, vetor [9] Salário liquido,
		vetor [2] Imposto de renda, vetor [3] Dependentes, vetor [4] vale alimentação,
		vetor [5] Vale alimentação, vetor [6] Vale refeição,
		vetor [7] Plano de saúde basico, vetor [8] Plano de saúde avançado */
		// Variáveis

		Scanner sc = new Scanner(System.in);
		double[] vetor = new double[10];
		String[] opcoes = {"Salário bruto: ","Salário liquido: ", "Imposto de renda: -", "Dependentes: ", "Vale alimentação: -",
				"Vale refeição: -", "Plano de saúde básico: -", "Plano de saúde Avançado: -"}; 
		...
		System.out.printf("Desconto %sR$%.2f\n",opcoes[j],vetor[j]);
		}
}
}
